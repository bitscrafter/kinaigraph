...
- **Speech is phrases, not a flap.** One pulse across the whole talk gives a
  ...
  phrases here, 1.4 s to 4.7 s, separated by pauses you can see, and the mouth
...
and a panel would have hidden the drawing it sits on. ⚠️ **The drawing stays out of the text's
half of the frame**, which is cheaper than making it faint enough to survive
behind words. Reach for one when the type
