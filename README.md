...
| [`wave-anatomy`](examples/wave-anatomy/)                     | `y = A · sin( B · (x − C) ) + D`, one beat per parameter. **No wave is pre-drawn anywhere** — every curve is generated from its own equation and sampled by the compiler.                                                                                                                                                                         | [watch](https://youtu.be/sB21lhQ5lDQ)                                             |
...
| [`milestone-ladder`](examples/milestone-ladder/)             | One life as six milestones on a rising ladder. Glyphs ride the rail they draw; two themes, light and dark.                                                                                                                                                                                                                                        | [teaser](https://youtu.be/qfoIFmeFFoQ) · [brief](https://youtu.be/kLVqbUwf8dg)    |
| [`life-lessons`](examples/life-lessons/)                     | Kinetic typography — quotes that fade in over paper texture, paced to spoken narration. The same two scenes in **English and Spanish**, sharing one paper, one stylesheet and one timeline: a localisation you can count rather than take on trust.                                                                                               | [English](https://youtu.be/jExzfqNyJm8) · [Spanish](https://youtu.be/4jVzo5C_-ho) |
